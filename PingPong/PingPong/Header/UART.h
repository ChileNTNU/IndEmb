...
#define bfReg_RxInterEnable     REGISTER_BIT(UCSR0B,7)      // Receive Enabled
#define bfReg_TxInterEnable     REGISTER_BIT(UCSR0B,6)      // Transmit Interrupt Enabled

#define bfReg_RxD_Enable        REGISTER_BIT(UCSR0B,4)      // Receive  Enable bit
#define bfReg_TxD_Enable        REGISTER_BIT(UCSR0B,3)      // Transmit Enable bit

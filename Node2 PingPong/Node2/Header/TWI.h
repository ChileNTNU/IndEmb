...
/****************************************************************************
   Slave addresses definitions
****************************************************************************/
#define DAC_MAX520_ADDR_READ    (0b01010001)   // DAC address for TWI communication. Read
#define DAC_MAX520_ADDR_WRITE   (0b01010000)   // DAC address for TWI communication. Write
